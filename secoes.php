        ...
        <section>
            ...
            <div class="mainpanel">
                <div class="contentpanel">
                    ...
                    <div class="row">
                        <form id="basicForm" action="cad_secao.php" class="form-horizontal" method="post">
                            <div class="col-md-4">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Seção</h4>
                                    </div>
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="form-group mb20">
                                                <input type="text" name="secao" maxlength="50" placeholder="Seção" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="panel-body">
                            ...
                            <div class="col-md-8">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Seções já cadastrados</h4>                                        
                                    </div>
                                    <div class="panel-body">
