            ...
            <div class="mainpanel">
                <div class="contentpanel">
                    <ol class="breadcrumb breadcrumb-quirk">
                        ...
                        <li class="active">Sistemas Operacionais</li>
                    </ol>
                    <div class="row">
                        <form id="basicForm" action="cad_sistoper.php" class="form-horizontal" method="post">
                            <div class="col-md-4">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Sistema Operacional</h4>
                                    </div>
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="form-group mb20">                                                
                                                <input type="text" maxlength="50" name="sistoper" placeholder="Sistema Operacional" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="panel-body">
                            ...
                            <div class="col-md-8">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Sistemas Operacionais já cadastrados</h4>                                        
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table id="dataTable1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    $filtro = $pdo->prepare("SELECT * FROM sistoper ORDER BY sistema ASC");
                                                    $filtro->execute();
                                                    while ($reg2 = $filtro->fetch(PDO::FETCH_ASSOC)) :
                                                        /* Para recuperar um ARRAY utilize PDO::FETCH_ASSOC */
                                                        echo("<tr>");
                                                        echo("<td>" . $reg2['id'] . "</td>");
                                                        echo("<td>" . $reg2['sistema'] . "</td>");
                                                        echo("<td>" . $reg2['qtdsisop'] . "</td>");
                                                        echo("</tr>");
                                                    endwhile;                                                    
                                                    ?>
                                                </tbody>
