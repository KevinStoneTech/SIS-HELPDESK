            ...
            <div class="mainpanel">
                <div class="contentpanel">
                    <ol class="breadcrumb breadcrumb-quirk">
                        ...
                        <li class="active">Chamados em aberto</li>
                    </ol>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Todos os chamados não finalizados</h4>
                                </div>
                                        ...
                                        <table id="dataTable1" class="table table-bordered table-striped table-condensed table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                while ($reg2 = $filtro->fetch(PDO::FETCH_ASSOC)) :
                                                    ...
                                                    if ($reg2['situacao'] == "3") {
                                                        echo("<th class='text-center'><i class='glyphicon glyphicon-ban-circle'></i></th>");
                                                    }
                                                    if ($reg2['situacao'] == "2") {
